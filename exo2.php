 ...
 <?php
    ...
    echo "Bonjour $prenom, nous sommes le $date. Il est actuellement $heure <br>";

    echo 'Bonjour ' . $prenom . ', nous sommes le ' . $date . '. Il est actuellement ' . $heure . ' <br>';

    printf("Bonjour %s, nous sommes le %s. Il est actuellement %s <br>", $prenom, $date, $heure);
    ?>
 ...
 <?php
    ...
    Bonjour <?= $prenom ?>, nous sommes le <?= $date ?>. Il est actuellement <?= $h ?>h<?= $m ?>
    <?php
    ?>
